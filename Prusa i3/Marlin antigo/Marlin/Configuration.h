...
#define STRING_CONFIG_H_AUTHOR "(Thiago Kunz, Maker Prusa i3)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,933.75}  // default steps per unit for Ultimaker
